...
_lr_productions = [
  ...
  ('instruction -> assignment SEMICOLON','instruction',2,'p_instruction','Mparser.py',38),
  ('instruction -> call SEMICOLON','instruction',2,'p_instruction','Mparser.py',39),
  ('instruction -> loop','instruction',1,'p_instruction','Mparser.py',40),
  ('instruction -> branch','instruction',1,'p_instruction','Mparser.py',41),
  ('instruction -> LCURLBRACK instructions RCURLBRACK','instruction',3,'p_instruction','Mparser.py',42),
  ('assignment -> ID assignment_operator expression','assignment',3,'p_assignment','Mparser.py',46),
  ('assignment -> ID matrix assignment_operator expression','assignment',4,'p_assignment','Mparser.py',47),
  ('assignment_operator -> ASSIGN','assignment_operator',1,'p_assignment_operator','Mparser.py',51),
  ('assignment_operator -> ADDASSIGN','assignment_operator',1,'p_assignment_operator','Mparser.py',52),
  ('assignment_operator -> SUBASSIGN','assignment_operator',1,'p_assignment_operator','Mparser.py',53),
  ('assignment_operator -> MULASSIGN','assignment_operator',1,'p_assignment_operator','Mparser.py',54),
  ('assignment_operator -> DIVASSIGN','assignment_operator',1,'p_assignment_operator','Mparser.py',55),
  ('expression -> term','expression',1,'p_expression','Mparser.py',59),
  ('expression -> LPARENT expression RPARENT','expression',3,'p_expression','Mparser.py',60),
  ('expression -> expression ADD expression','expression',3,'p_num_expression_binary','Mparser.py',64),
  ('expression -> expression SUB expression','expression',3,'p_num_expression_binary','Mparser.py',65),
  ('expression -> expression MUL expression','expression',3,'p_num_expression_binary','Mparser.py',66),
  ('expression -> expression DIV expression','expression',3,'p_num_expression_binary','Mparser.py',67),
  ('expression -> expression DOTADD expression','expression',3,'p_num_expression_binary','Mparser.py',68),
  ('expression -> expression DOTSUB expression','expression',3,'p_num_expression_binary','Mparser.py',69),
  ('expression -> expression DOTMUL expression','expression',3,'p_num_expression_binary','Mparser.py',70),
  ('expression -> expression DOTDIV expression','expression',3,'p_num_expression_binary','Mparser.py',71),
  ('expression -> SUB expression','expression',2,'p_expression_negation','Mparser.py',75),
  ('expression -> expression TRANSPOSE','expression',2,'p_expression_transpose','Mparser.py',79),
  ('comparison -> expression comparison_operator expression','comparison',3,'p_comparison','Mparser.py',84),
  ('comparison_operator -> SMALLER','comparison_operator',1,'p_comparison_operator','Mparser.py',88),
  ('comparison_operator -> LARGER','comparison_operator',1,'p_comparison_operator','Mparser.py',89),
  ('comparison_operator -> SMALLEREQ','comparison_operator',1,'p_comparison_operator','Mparser.py',90),
  ('comparison_operator -> LARGEREQ','comparison_operator',1,'p_comparison_operator','Mparser.py',91),
  ('comparison_operator -> NOTEQ','comparison_operator',1,'p_comparison_operator','Mparser.py',92),
  ('comparison_operator -> EQ','comparison_operator',1,'p_comparison_operator','Mparser.py',93),
  ('call -> BREAK','call',1,'p_call','Mparser.py',97),
  ('call -> CONTINUE','call',1,'p_call','Mparser.py',98),
  ('call -> RETURN expression','call',2,'p_call','Mparser.py',99),
  ('call -> PRINT print_inputs','call',2,'p_call','Mparser.py',100),
  ('print_inputs -> print_inputs COMMA print_input','print_inputs',3,'p_print_inputs','Mparser.py',104),
  ('print_inputs -> print_input','print_inputs',1,'p_print_inputs','Mparser.py',105),
  ('print_input -> STRING','print_input',1,'p_print_input','Mparser.py',109),
  ('print_input -> ID','print_input',1,'p_print_input','Mparser.py',110),
  ('matrix_fun -> fun_name LPARENT expression RPARENT','matrix_fun',4,'p_matrix_fun','Mparser.py',114),
  ('fun_name -> EYE','fun_name',1,'p_fun_name','Mparser.py',118),
  ('fun_name -> ZEROS','fun_name',1,'p_fun_name','Mparser.py',119),
  ('fun_name -> ONES','fun_name',1,'p_fun_name','Mparser.py',120),
  ('loop -> for','loop',1,'p_loop','Mparser.py',124),
  ('loop -> while','loop',1,'p_loop','Mparser.py',125),
  ('for -> FOR for_expression instruction','for',3,'p_for','Mparser.py',129),
  ('for_expression -> ID ASSIGN range','for_expression',3,'p_for_expression','Mparser.py',133),
  ('while -> WHILE LPARENT comparison RPARENT instruction','while',5,'p_while','Mparser.py',137),
  ('branch -> IF LPARENT comparison RPARENT instruction','branch',5,'p_branch','Mparser.py',141),
  ('branch -> IF LPARENT comparison RPARENT instruction ELSE instruction','branch',7,'p_branch','Mparser.py',142),
  ('range -> num_term COLON num_term','range',3,'p_range','Mparser.py',146),
  ('term -> ID','term',1,'p_term','Mparser.py',150),
  ('term -> number','term',1,'p_term','Mparser.py',151),
  ('term -> matrix','term',1,'p_term','Mparser.py',152),
  ('term -> string','term',1,'p_term','Mparser.py',153),
  ('num_term -> ID','num_term',1,'p_num_term','Mparser.py',157),
  ('num_term -> number','num_term',1,'p_num_term','Mparser.py',158),
  ('matrix_term -> ID','matrix_term',1,'p_matrix_term','Mparser.py',162),
  ('matrix_term -> matrix','matrix_term',1,'p_matrix_term','Mparser.py',163),
  ('matrix_term -> number','matrix_term',1,'p_matrix_term','Mparser.py',164),
  ('number -> INT','number',1,'p_number','Mparser.py',168),
  ('number -> FLOAT','number',1,'p_number','Mparser.py',169),
  ('string -> STRING','string',1,'p_string','Mparser.py',173),
  ('matrix -> LSQBRACK matrix_contents RSQBRACK','matrix',3,'p_matrix','Mparser.py',177),
  ('matrix -> matrix_fun','matrix',1,'p_matrix','Mparser.py',178),
  ('matrix_contents -> matrix_contents COMMA matrix_content','matrix_contents',3,'p_matrix_contents','Mparser.py',182),
  ('matrix_contents -> matrix_content','matrix_contents',1,'p_matrix_contents','Mparser.py',183),
  ('matrix_content -> matrix_term','matrix_content',1,'p_matrix_content','Mparser.py',187),
]
